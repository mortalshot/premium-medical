...
class Popup {
	constructor(options) {
		let config = {
			...
			init: true,
			//Для кнопок
			attributeOpenButton: 'data-fls-popup-link', // Атрибут для кнопки, которая вызывает Popup
			attributeCloseButton: 'data-fls-popup-close', // Атрибут для кнопки, что закрывает popup
			...
			classes: {
				...
				bodyActive: 'data-fls-popup-open', // Прилагается для боди, когда попал открытый
			},
