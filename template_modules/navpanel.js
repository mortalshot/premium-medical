...
export function navPanel() {
	...
	if (htmlFiles.length > 1 || isIconFont || templateConfig.projectpage.enable || (templateConfig.devcomponents.enable && !isProduction)) {
		...
		!isProduction && templateConfig.projectpage.enable ? menu += `<li><hr></li><li><a target="_blank" href="${templateConfig.projectpage.template.replace('src', '')}">Шаблон страницы проекта</a></li>` : ''
		!isProduction && templateConfig.devcomponents.enable ? menu += `<li><hr></li><li><a target="_blank" href="${templateConfig.devcomponents.filename}">Разработка компонентов</a></li>` : ''
		menu += `</ul>`
		menu += `<style>
			#fls-dev-panel{
				position: fixed;
